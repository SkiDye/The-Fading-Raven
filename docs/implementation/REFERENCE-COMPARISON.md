...
| 지휘관 영입 노드 | 깃발 섬 대응 (RECRUIT) | 🔴 높음 |
| 도주(Flee) 시스템 | 빈 침투정으로 탈출 | 🔴 높음 |
| 카메라 컨트롤 | Q/E 회전, 마우스 휠 줌 | 🔴 높음 |
| 일시정지 시스템 | 스페이스바 토글 | 🔴 높음 |
| 웨이브 방향 표시 | 화면 가장자리 화살표 | 🟡 중간 |
| 이동 가능 타일 표시 | 흰색 핀 마커 | 🟡 중간 |
| 유닛 선택 슬로우 모션 | 선택 시 자동 시간 감속 | 🟡 중간 |
| 숫자 키 분대 선택 | 1-4 키 바인딩 | 🟡 중간 |
| 난이도 설정 | Easy/Normal/Hard/Very Hard | 🟡 중간 |
...
| Fearless 특성 | **철수 불가** (페널티) | Fearless 구현 | ✅ |
